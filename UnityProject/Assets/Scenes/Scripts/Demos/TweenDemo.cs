...
{
    public AnimationCurve curve; // Creates a curve editor in inspector
    ...
    void DoInterp()
    {
        ...
        p = curve.Evaluate(p); // applies the curve to the tween
...
public class EditorTweenDemo : Editor // Creates a button in the inspector
{
